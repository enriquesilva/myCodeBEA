...
<style>
  ...
  <script type="text/javascript">
    $(function(){
      ...
      //Se inicializa el mapa. Se dibujan todos los puntos de control de la ruta.  
      $('#map').gmap3({
        map:{
          options:{
            center: arrCenter,
...
<?php if($this->Session->check('LastPoint.prRuta')) {?><div class="backContainer"><?php $this->Form->postLink("Volver al listado",array('action' => 'index'),array('data'=>array('puntocontrol'=>array('ruta_id'=>$this->Session->read('LastPoint.prRuta'))),'escape'=>false,'confirm' => '¿Volver al listado? Cambios no guardados se descartarán'));?></div><?php } ?>
<div id="tool">
	<?php
