...
<head>
	...
	<title>AVA - Reporte detallado de vuelta</title>
	<?php
...
<body>
	<div id="container">
		<div id="header">
			<h1><a href="/fenix">AVA</a></h1>	
			<?php if($this->Session->check('Auth.User')) {	?> <a href="#" onclick="window.close()">Volver al Reporte General</a>	<?php } ?>
		</div>
		<div id="content">
